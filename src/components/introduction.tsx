            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 xl:grid-cols-4 border-b pb-8 pt-24 border-base-200 dark:border-base-800">
                ...
                <div className="md:col-span-2 xl:col-span-3">
                    ...
                    >
                        ...
                        user-friendly software and streamlining workflows through automation. With
                        experience in both software engineering and DevOps, I enjoy solving complex
                        challenges and creating efficient, maintainable solutions. Outside of tech,
                        I love photography and drone videography, capturing unique perspectives.
                    </Text>
                </div>
            </div>
        </Wrapper>
